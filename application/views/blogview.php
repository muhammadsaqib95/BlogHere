    ...
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
        ...
        <a class="btn btn-sm btn-outline-secondary" href="#">Sign up</a>
                ...
                <div class="text-align-center" style="padding-top:2rem">
                <?php
                // echo "<pre>";
                // print_r($blog);
                // die();
                ?>
                <!-- <div class="h2 mb-4" style="margin-left:25rem"><?= $blog[0]['b_Title']?>
                </div> -->

                <div style="margin-left:15rem">
                <img src="<?= base_url($blog[0]['b_Img']); ?>" width="600" hight="400" >
                </div>

                <!-- <div class="mt-3"><p><?= $blog[0]['b-Discription']?></p></div> -->
                </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-8 blog-main">
      ...
      <div class="blog-post">
        ...
        <p class="blog-post-meta"><?= substr($blog[0]['b_Create_on'],0,10)?> by <a href="#">Mark</a></p>
        <p><?= $blog[0]['b-Discription']?></p>
    ...
    <aside class="col-md-4 blog-sidebar">
      <div class="p-4 mb-3 bg-light rounded">
        ...
        <p class="mb-0">BlogHere is a platform where you can find out reviews on mnay topics by many editors.</p>
      </div>
